...
export class PlaybookDiagnostics {
  ...
  private validateRailsLine(
    ...
    while ((match = componentRegex.exec(line)) !== null) {
      ...
      if (!component) {
        ...
        // Validate props
        this.validateProps(line, lineIndex, component, diagnostics, "rails")
      }
    }
  }
  ...
  private validateReactLine(
    ...
    while ((match = componentRegex.exec(line)) !== null) {
      ...
      if (component) {
        this.validateProps(line, lineIndex, component, diagnostics, "react")
      }
    }
  }
    ...
    if (type === "rails") {
      ...
      while ((match = propRegex.exec(line)) !== null) {
        ...
        if (!component.props[snakeCaseProp]) {
          ...
          // Validate enum values
          const prop = component.props[snakeCaseProp]
